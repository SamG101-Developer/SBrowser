...
if(NOT "${QT_HOST_PATH}" STREQUAL "")
     ...
     set(BACKUP_Quick3DUtils_CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH})
     set(BACKUP_Quick3DUtils_CMAKE_FIND_ROOT_PATH ${CMAKE_FIND_ROOT_PATH})
...
foreach(_target_dep ${_tool_deps})
    ...
    if (NOT ${pkg}_FOUND)
        if(NOT "${QT_HOST_PATH}" STREQUAL "")
             set(CMAKE_PREFIX_PATH ${BACKUP_Quick3DUtils_CMAKE_PREFIX_PATH})
             set(CMAKE_FIND_ROOT_PATH ${BACKUP_Quick3DUtils_CMAKE_FIND_ROOT_PATH})
        endif()
        return()
    endif()
endforeach()
...
set(_target_deps "Qt6Core\;6.0.1;Qt6Gui\;6.0.1")
...
set(_Qt6Quick3DUtils_MODULE_DEPENDENCIES "Core;Gui")
