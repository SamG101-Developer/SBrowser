...
set(_tool_deps "Qt6Quick3DTools\;6.0.1")

if(NOT "${QT_HOST_PATH}" STREQUAL "")
     # Make sure that the tools find the host tools first
     set(BACKUP_Quick3D_CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH})
     set(BACKUP_Quick3D_CMAKE_FIND_ROOT_PATH ${CMAKE_FIND_ROOT_PATH})
...
foreach(_target_dep ${_tool_deps})
    ...
    if (NOT ${pkg}_FOUND)
        if(NOT "${QT_HOST_PATH}" STREQUAL "")
             set(CMAKE_PREFIX_PATH ${BACKUP_Quick3D_CMAKE_PREFIX_PATH})
             set(CMAKE_FIND_ROOT_PATH ${BACKUP_Quick3D_CMAKE_FIND_ROOT_PATH})
        endif()
        return()
    endif()
endforeach()
...
set(_target_deps "Qt6Core\;6.0.1;Qt6Gui\;6.0.1;Qt6Qml\;6.0.1;Qt6Quick\;6.0.1;Qt6Quick3DRuntimeRender\;6.0.1")
