...
set_target_properties(Qt6::balsam PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/balsam.exe"
  )
...
set_target_properties(Qt6::meshdebug PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/meshdebug.exe"
  )
...
set_target_properties(Qt6::shadergen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/shadergen.exe"
  )
