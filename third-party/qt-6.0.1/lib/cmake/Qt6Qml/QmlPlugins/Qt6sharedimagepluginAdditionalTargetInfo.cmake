...
get_target_property(_qt_imported_implib Qt6::sharedimageplugin IMPORTED_IMPLIB_RELEASE)
get_target_property(_qt_imported_soname Qt6::sharedimageplugin IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::sharedimageplugin PROPERTY IMPORTED_IMPLIB_RELWITHDEBINFO "${_qt_imported_implib}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::sharedimageplugin PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
