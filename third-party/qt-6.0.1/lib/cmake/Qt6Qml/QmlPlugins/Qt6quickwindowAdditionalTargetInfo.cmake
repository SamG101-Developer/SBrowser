...
get_target_property(_qt_imported_implib Qt6::quickwindow IMPORTED_IMPLIB_RELEASE)
get_target_property(_qt_imported_soname Qt6::quickwindow IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::quickwindow PROPERTY IMPORTED_IMPLIB_RELWITHDEBINFO "${_qt_imported_implib}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::quickwindow PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
