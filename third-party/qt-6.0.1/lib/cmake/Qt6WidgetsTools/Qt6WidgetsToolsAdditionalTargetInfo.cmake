...
get_target_property(_qt_imported_implib Qt6::uic IMPORTED_IMPLIB_RELEASE)
get_target_property(_qt_imported_soname Qt6::uic IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::uic PROPERTY IMPORTED_IMPLIB_RELWITHDEBINFO "${_qt_imported_implib}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::uic PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
