...
if (NOT QT_NO_CREATE_TARGETS)
    get_property(is_global TARGET Qt6::windeployqt PROPERTY IMPORTED_GLOBAL)
    if(NOT is_global)
        set_property(TARGET Qt6::windeployqt PROPERTY IMPORTED_GLOBAL TRUE)
    endif()
endif()
set(Qt6ToolsTools_TARGETS "Qt6::qhelpgenerator;Qt6::qtattributionsscanner;Qt6::windeployqt")
