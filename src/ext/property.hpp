...
namespace ext {template <typename ...Args, typename T> auto property_multi_cast(const ext::property<T>& o) -> bool;}
...
public friends:
    ...
    // casting
    template <typename ...Args, typename V> friend auto property_multi_cast(const ext::property<V>& o) -> bool;
...
template <typename T>
ext::property<T>::operator T() const
{
...
template<typename T>
auto ext::property<T>::operator=(const T& o) -> ext::property<T>&
{
...
template <typename T>
auto ext::property<T>::operator=(T&& o) noexcept -> ext::property<T>&
{
...
template <typename T>
template <typename U>
ext::property<T>::operator U() const requires (not std::is_same_v<T, U>)
{
    // TODO
    return (U)m_internal;
}
...
template <typename T>
template <typename U>
auto ext::property<T>::operator=(const ext::property<U>& o) -> ext::property<T>& requires (not std::is_same_v<T, U>)
{
    // TODO
    m_internal = (T)o;
    return *this;
...
template <typename T>
auto ext::property<T>::operator->() const -> T requires (std::is_pointer_v<T>)
{
...
template <typename T>
template <typename U>
auto ext::property<T>::operator==(const U& o) const -> bool
{
...
template <typename T>
template <typename U>
auto ext::property<T>::operator+=(const U& o) -> ext::property<T>&
{
...
template <typename T>
auto ext::property<T>::operator<<=(const size_t n) -> ext::property<T>& requires (not std::is_arithmetic_v<T>)
{
...
template <typename T>
auto ext::property<T>::operator++() -> ext::property<T>&
{
...
template <typename T>
template <typename U>
auto ext::property<T>::operator+(const U& o) const -> ext::property<T>
{
...
template <typename T>
auto ext::property<T>::operator<<(const size_t n) const -> ext::property<T> requires (not std::is_arithmetic_v<T>)
{
...
template <typename T>
auto ext::property<T>::operator++(const int n) const -> ext::property<T>
{
...
template <typename T>
auto ext::property<T>::operator+() const -> ext::property<T>
{
...
template <typename T>
auto ext::property<T>::operator!() const -> bool
{
...
template <typename T>
auto ext::property<T>::operator*() const -> std::remove_pointer_t<T> requires (std::is_pointer_v<T>)
{
    return *m_internal;
}
...
template <typename T>
auto ext::property<T>::operator*() const -> T requires (not std::is_pointer_v<T>)
{
    return m_internal;
}
...
template <typename T>
template <typename U>
auto ext::property<T>::operator[](const size_t i) const -> U&
{
...
auto ext::property<T>::operator()(Args&&... args) const -> U&
{
