...
auto dom::helpers::trees::root(const nodes::node* const node) -> dom::nodes::node*
{
...
auto dom::helpers::trees::descendants(const nodes::node* const node) -> ext::vector<dom::nodes::node*>
{
...
auto dom::helpers::trees::ancestors(const nodes::node* const node) -> ext::vector<dom::nodes::node*>
{
...
auto dom::helpers::trees::is_descendant(const nodes::node* const node_a, const nodes::node* const node_b) -> bool
{
...
auto dom::helpers::trees::is_ancestor(const nodes::node* const node_a, const nodes::node* const node_b) -> bool
{
...
auto dom::helpers::trees::is_sibling(const nodes::node* const node_a, const nodes::node* const node_b) -> bool
{
...
auto dom::helpers::trees::is_preceding(const nodes::node* const node_a, const nodes::node* const node_b) -> bool
{
...
auto dom::helpers::trees::is_following(const nodes::node* const node_a, const nodes::node* const node_b) -> bool
{
...
auto dom::helpers::trees::index(const nodes::node* const node_a) -> unsigned long
{
...
auto dom::helpers::trees::length(const nodes::node* const node_a) -> unsigned long
{
...
template <typename T>
auto dom::helpers::trees::all_following(const nodes::node* const node_a) -> ext::vector<dom::nodes::node*>
{
...
template <typename T>
auto dom::helpers::trees::all_preceding(const nodes::node* const node_a) -> ext::vector<dom::nodes::node*>
{
...
template <typename T>
auto dom::helpers::trees::all_following_siblings(const nodes::node* const node_a) -> ext::vector<dom::nodes::node*>
{
...
template <typename T>
auto dom::helpers::trees::all_preceding_siblings(const nodes::node* const node_a) -> ext::vector<dom::nodes::node*>
{
...
auto dom::helpers::trees::is_element_node(const nodes::node* const node_a) -> bool
{
...
auto dom::helpers::trees::is_text_node(const nodes::node* const node_a) -> bool
{
...
auto dom::helpers::trees::is_document_type_node(const nodes::node* const node_a) -> bool
{
...
auto dom::helpers::trees::descendant_text_content(const nodes::node* const node_a) -> ext::string
{
...
auto dom::helpers::trees::child_text_content(const nodes::node* const node_a) -> ext::string
{
