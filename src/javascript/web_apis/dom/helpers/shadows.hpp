...
struct dom::helpers::shadows final
{
    ...
    static auto find_slot(
            ...
            bool open_flag = false) -> html::elements::html_slot_element*;

    static auto find_slottables(
            const html::elements::html_slot_element* slot) -> ext::vector<nodes::node*>;
    ...
    static auto assign_slot(
            const nodes::node* slottable) -> void;

    static auto assign_slottables(
            const html::elements::html_slot_element* slot) -> void;

    static auto assign_slottables_for_tree(
            const nodes::node* descendant) -> void;
