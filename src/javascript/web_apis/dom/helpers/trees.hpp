...
struct dom::helpers::trees final
{
    ...
    static auto descendants(
            const nodes::node* node) -> ext::vector<nodes::node*>;
    ...
    static auto index(
            const nodes::node* node_a) -> unsigned long;
    ...
    static auto all_following(
            const nodes::node* node_a) -> ext::vector<nodes::node*>;
    ...
    static auto descendant_text_content(
            const nodes::node* node_a) -> ext::string;

    static auto child_text_content(
            const nodes::node* node_a) -> ext::string;

    static auto descendant_text_nodes(
            const nodes::node* node_a) -> ext::vector<nodes::text*>;
    ...
    static auto common_ancestor(
            const nodes::node* node_a,
            const nodes::node* node_b) -> nodes::node*;
};
