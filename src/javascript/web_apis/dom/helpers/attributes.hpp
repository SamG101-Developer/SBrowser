...
struct dom::helpers::attributes {
    ...
    static nodes::attr* get_attribute_by_name(ext::cstring& qualified_name, nodes::element* owner_element);
    static nodes::attr* get_attribute_by_ns(ext::cstring& namespace_, ext::cstring& local_name, nodes::element* owner_element);
    static ext::string get_attribute_value(nodes::element* owner_element, ext::cstring& namespace_, ext::cstring& local_name = "");
    ...
    static nodes::attr* remove_attribute_by_name(ext::cstring& qualified_name, nodes::element* owner_element);
    static nodes::attr* remove_attribute_by_ns(ext::cstring& namespace_, ext::cstring& local_name, nodes::element* owner_element);
