        ...
        -> ext::any
{
    return v8pp::class_<document>{isolate}
            ...
            .template inherit<dom::mixins::document_or_element_node<document>>()
            .template inherit<dom::mixins::document_or_shadow_root<document>>()
            .template inherit<dom::mixins::parent_node<document>>()
            .template inherit<dom::mixins::non_element_parent_node<document>>()
            .template inherit<dom::xpath::xpath_evaluator>()
            .template inherit<ext::listlike<node*>>()
            .template function("createElement", &document::create_element)
            .template function("createElementNS", &document::create_element_ns)
            .template function("createDocumentFragment", &document::create_document_fragment)
            .template function("createTextNode", &document::create_text_node)
            .template function("createCDataSectionNode", &document::create_cdata_section_node)
            .template function("createComment", &document::create_comment)
            .template function("createProcessingInstruction", &document::create_processing_instruction)
            .template function("createAttribute", &document::create_attribute)
            .template function("createAttributeNS", &document::create_attribute_ns)
            .template function("createRange", &document::create_range)
            .template function("createNodeIterator", &document::create_node_iterator)
            .template function("createTreeWalker", &document::create_tree_walker)
            .template function("importNode", &document::import_node)
            .template function("adoptNode", &document::adopt_node)
            .template function("getElementsByName", &document::get_elements_by_name)
            // .template function("open", &document::open)
            .template function("close", &document::close)
            // .template function("write", &document::write)
            // .template function("writeln", &document::writeln)
            .template function("hasFocus", &document::has_focus)
            .template function("execCommand", &document::exec_command)
            .template function("queryCommandEnabled", &document::query_command_enabled)
            .template function("queryCommandIndeterm", &document::query_command_indeterm)
            .template function("queryCommandState", &document::query_command_state)
            .template function("queryCommandSupported", &document::query_command_supported)
            .template function("queryCommandValue", &document::query_command_value)
            .template function("elementFromPoint", &document::element_from_point)
            .template function("elementsFromPoint", &document::elements_from_point)
            .template function("caretPositionFromPoint", &document::caret_position_from_point)
            .template var("URL", &document::url, true)
            .template var("compatMode", &document::compat_mode, true)
            .template var("characterSet", &document::character_set, true)
            .template var("contentType", &document::content_type, true)
            .template var("doctype", &document::doctype, true)
            .template var("documentElement", &document::document_element, true)
            .template var("implementation", &document::implementation, true)
            .template var("domain", &document::domain, true)
            .template var("cookie", &document::cookie)
            .template var("referrer", &document::referrer, true)
            .template var("lastModified", &document::last_modified, true)
            .template var("readyState", &document::ready_state, true)
            .template var("dir", &document::dir)
            .template var("designMode", &document::design_mode)
            .template var("title", &document::title)
            .template var("location", &document::location)
            .template var("body", &document::body)
            .template var("head", &document::head, true)
            .template var("images", &document::images, true)
            .template var("links", &document::links, true)
            .template var("forms", &document::forms, true)
            .template var("scripts", &document::scripts, true)
            .template var("defaultView", &document::default_view, true)
            .template var("scrollingElement", &document::scrolling_element)
            .template var("namedFlows", &document::named_flows)
            .auto_wrap_objects();
}
