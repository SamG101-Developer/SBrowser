        ...
        -> ext::any
{
    return v8pp::class_<range>{isolate}
            ...
            .template function("setStart", &range::set_start)
            .template function("setStartAfter", &range::set_start_after)
            .template function("setStartBefore", &range::set_start_before)
            .template function("setEnd", &range::set_end)
            .template function("setEndAfter", &range::set_end_after)
            .template function("setEndBefore", &range::set_end_before)
            .template function("insertNode", &range::insert_node)
            .template function("intersectsNode", &range::intersects_node)
            .template function("selectNode", &range::select_node)
            .template function("selectNodeContents", &range::select_node_contents)
            .template function("compareBoundaryPoints", &range::compare_boundary_points)
            .template function("comparePoint", &range::compare_point)
            .template function("extractContents", &range::extract_contents)
            .template function("cloneContents", &range::clone_contents)
            .template function("deleteContents", &range::delete_contents)
            .template function("surroundContents", &range::surround_contents)
            .template function("collapse", &range::collapse)
            .template function("cloneRange", &range::clone_range)
            .template function("isPointInRange", &range::is_point_in_range)
            .template function("toJSON", &range::to_json)
            .template var("commonAncestorContainer", &range::common_ancestor_container)
            .auto_wrap_objects();
}
