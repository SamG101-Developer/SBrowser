...
dom::ranges::static_range::static_range(ext::cstring_any_map& init) {
    ...
    helpers::exceptions::throw_v8_exception(
            ...
            [init] -> bool {return ext::any_cast<nodes::attr*>(init.at("startContainer")) or ext::any_cast<nodes::attr*>(init.at("endContainer"));});

    helpers::exceptions::throw_v8_exception(
            "range containers must be non-document_type nodes",
            INVALID_NODE_TYPE_ERR,
            [init] -> bool {return ext::any_cast<nodes::document_type*>(init.at("startContainer")) or ext::any_cast<nodes::document_type*>(init.at("endContainer"));});
